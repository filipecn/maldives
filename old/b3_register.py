...
class B3Register:
    def __init__(self, string):
        ...
        self.attributes["date"] = '-'.join([string[2:6], string[6:8], string[8:10]])
        ...
        self.attributes["openPrice"] = float(string[56:69]) / 100
        self.attributes["maxPrice"] = float(string[69:82]) / 100
        self.attributes["minPrice"] = float(string[82:95]) / 100
        self.attributes["medPrice"] = float(string[95:108]) / 100
        self.attributes["closePrice"] = float(string[108:121]) / 100
        self.attributes["bestBuyOffer"] = float(string[121:134]) / 100
        self.attributes["bestSellOffer"] = float(string[134:147]) / 100
        ...
        self.attributes["quoteFactor"] = int(string[210:217]) # fator de cotacao do papel (ex: 1000 = cotacao por lote de 1000)
